App.MatchController = Ember.ArrayController.extend({
    ...
    actions: {
        nextTurn: function () {
            if (this.currentPlayer && this.currentPlayer.total > 20) {
                alert(this.currentPlayer.user.name + "LOSES! he drew more than 2 this round!");
                return;
            }
            ...
            if (this.currentPlayer.total === 20) {
                alert(this.currentPlayer.user.name + "WINS this round!");
            }
